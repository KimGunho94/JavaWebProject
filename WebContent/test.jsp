 ...
 <header>
    <div class="head_box">
      <div class="head_content">
        <div class="head_title">
          <h1><a href="Main.jsp"><img src="resources/images/stu_logo.png" alt=""></a></h1>
        </div>
         <%
          ...
          <div class="gnb_content">
	        ...
	        <div class="profil_box">
	        	<ul>
	        		...
	        		<li><a href="LogoutAction.jsp?page=5">로그아웃</a></li>
	        	</ul>
	        </div>
        </div>
        <%
    ...
    <div class="lnb_box">
      <div class="lnb_content">
        <ul>
          <li><a href="Main.jsp" class="on">홈</a></li>
...
<div id="write_body">
	<form action="ExUploadServlet" id="add_diary" enctype="multipart/form-data" method="POST">
	...
	<div id="write_ctt_box">
		...
		<div id="list_btn">
			...
			<button id="cancel_btn" onclick="showFileName()">취소</button>
		</div>
	</form>
</div>
</body>
